...
DBFS_DATASET_LOCATION = '/tmp/FileStore/datasets/'
CANCER_CSV_PATH = '../datasets/' + CANCER_FILE_NAME # CSV
UNECE_JSON_PATH = '../datasets/' + UNECE_FILE_NAME # simple JSON
USED_CAR_JSON_PATH = '../datasets/' + USED_CAR_FILE_NAME # complex JSON
MALL_CUSTOMER_PATH='../datasets/' + MALL_CUSTOMER_FILE_NAME
DBFS_PARQUET_FILE = '/tmp/FileStore/datasets/USED_CAR_PARQUET/'
HOUSE_PRICE_FILE = 'missing_val_dataset.csv'
HOUSE_PRICE_PATH = '../datasets/' + HOUSE_PRICE_FILE
GAME_STREAM_FILE = 'steam-200k.csv'
GAME_STREAM_PATH = '../datasets/' + GAME_STREAM_FILE
ORDER_DETAIL_FILE = 'orderdetails.csv'
ORDER_DETAIL_PATH = '../datasets/Sales-Order/'+ORDER_DETAIL_FILE
ORDER_LIST_FILE = 'orderlist.csv'
ORDER_LIST_PATH = '../datasets/Sales-Order/' + ORDER_LIST_FILE
SALES_TARGET_FILE = 'salestarget.csv'
SALES_TARGET_PATH = '../datasets/Sales-Order/'+SALES_TARGET_FILE
DA = {
